			...
			["Thalatar"] = {
				...
				["forms"] = {
					...
					["EquipShield"] = {
						...
						[4] = "equipOffHand=Kresh's Back-sayInSay=Equipping shield-ifNotEquipped=Kresh's Back",
					},
					["BattleCommon"] = {
						[1] = "autoAttack",
						[2] = "use=Lesser Healing Potion-sayInSay=Healing Potion!-ifInCombat-ifPlayer<10%hp-ifNotItemInCooldown=Lesser Healing Potion",
						[3] = "#Intimidating Shout 25 rage",
						[4] = "intimidatingShout-sayInSay=Intimidating Shout!-ifNotInCooldown=intimidatingShout-ifItemInCooldown=Lesser Healing Potion-ifPlayer<20%hp-ifPlayer>25rage",
						...
						[25] = "# Bloodrage 0 rage",
						[26] = "bloodrage-sayInSay=Bloodrage!-ifNotInCooldown=bloodrage-ifNotPlayerHasBuff=bloodrage-ifPlayer>60hp-ifPlayer>10%hp",
						...
						[30] = "battleShout-sayInSay=Battle Shout!-ifPlayer>10rage-ifNotPlayerHasBuff=battleShout",
						[31] = "battleShout-sayInSay=Battle Shout!-ifPlayer>10rage-ifBuffDuration<3s=battleShout",
						[32] = "# Disarm 20 rage",
						...
						[34] = "# Rend 10 rage",
						[35] = "rend-sayInSay=Not in melee range!-ifNotTargetInMeleeRange",
						[36] = "rend-sayInSay=Rend!-ifPlayer>35rage-ifPlayerHasBuff=battleShout-ifNotTargetHasDebuff=rend-ifNotTargetImmune=rend-ifTimeToDeath>15s",
						[37] = "# Demoralizing Shout 10 rage",
						[38] = "demoShout-sayInSay=Demoralizing Shout!-ifPlayer>35rage-ifPlayerHasBuff=battleShout-ifNotTargetHasDebuff=demoShout",
					},
					["Hamstring"] = {
					...
					["EquipTwoHandWeapon"] = {
						[1] = "equipMainHand=Taskmaster Axe-sayInSay=Equipping 2 hander-ifNotEquipped=Taskmaster Axe",
					},
					["tank"] = {
